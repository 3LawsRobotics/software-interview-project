...
/// @brief C++ wrapper around matplotlib
/// @details Modified version of:
/// https://github.com/lava/matplotlib-cpp/blob/master/matplotlibcpp.h
/// Don't forget in your CMakeLists.txt to have:
/// find_package(Python3 COMPONENTS Interpreter Development NumPy REQUIRED)
/// target_link_libraries(my_library PRIVATE Python3::Python Python3::Module Python3::NumPy)
/// @author Benno Evers, modified by Thomas Gurriet (tgurriet@3laws.io)
/// @copyright Copyright 2014 Benno Evers
/// @par License
///  Distributed under the MIT License, see:
/// https://github.com/lava/matplotlib-cpp/blob/master/LICENSE

#ifndef THREELAWS_MATPLOTLIBCPP_HPP
#define THREELAWS_MATPLOTLIBCPP_HPP
...
#if PY_MAJOR_VERSION < 3 || PY_MAJOR_VERSION > 3 || (PY_MAJOR_VERSION == 3 && PY_MINOR_VERSION > 10)
    char name[]               = "plotting";
    char const * dummy_args[] = {
      "Python", NULL};  // const is needed because literals must not be modified
#if PY_MAJOR_VERSION < 3
    char const ** argv = dummy_args;
#else
    char ** dummy = (char **)malloc(2 * sizeof(char *));  // NOLINT
    char * first  = (char *)malloc(7);                    // NOLINT
    dummy[0]      = first;
    dummy[1]      = NULL;
    strcpy(first, "Python");  // NOLINT
    char ** argv{dummy};
#endif
#else  // PY_MAJOR_VERSION == 3 && PY_MINOR_VERSION <= 10
...
#else
    PySys_SetArgv(argc, static_cast<char **>(argv));
#endif
#endif
...
inline void backend(const std::string & name) { detail_matplotlib::s_backend = name; }

inline bool annotate(std::string annotation, double x, double y)
{
  detail_matplotlib::_interpreter::get();
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_annotate, args, kwargs);
...
PyObject * get_array(const std::vector<Numeric> & v)
{
  ...
  for (size_t i = 0; i < v.size(); ++i) { PyList_SetItem(list, i, PyFloat_FromDouble(v.at(i))); }
  return list;
}
...
PyObject * get_listlist(const std::vector<std::vector<Numeric>> & ll)
{
  ...
  for (std::size_t i = 0; i < ll.size(); ++i) { PyList_SetItem(listlist, i, get_array(ll[i])); }
  return listlist;
}
  ...
  const std::map<std::string, std::string> & keywords)
{
  ...
  // using numpy arrays
  PyObject * xarray = detail_matplotlib::get_array(x);
  PyObject * yarray = detail_matplotlib::get_array(y);
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_plot, args, kwargs);
...
// a non-numpy alternative for `detail_matplotlib::get_2darray()`.
#ifndef WITHOUT_NUMPY
template<typename Numeric>
  ...
  const long fig_number                               = 0)  // NOLINT
{
  ...
  // using numpy arrays
  PyObject * xarray = detail_matplotlib::get_2darray(x);
  PyObject * yarray = detail_matplotlib::get_2darray(y);
  PyObject * zarray = detail_matplotlib::get_2darray(z);
  ...
  PyObject * python_colormap_coolwarm =
    PyObject_GetAttrString(detail_matplotlib::_interpreter::get().s_python_colormap, "coolwarm");
  ...
  PyObject * fig_exists = PyObject_CallObject(
    detail_matplotlib::_interpreter::get().s_python_function_fignum_exists, fig_args);
  if (!PyObject_IsTrue(fig_exists)) {
    fig = PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_figure,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple);
  } else {
    fig = PyObject_CallObject(
      detail_matplotlib::_interpreter::get().s_python_function_figure, fig_args);
  }
  ...
  Py_INCREF(gca);
  PyObject * axis =
    PyObject_Call(gca, detail_matplotlib::_interpreter::get().s_python_empty_tuple, gca_kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_contour, args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_spy, plot_args, kwargs);
  ...
  const long fig_number                               = 0)  // NOLINT
{
  ...
  PyObject * xarray = detail_matplotlib::get_array(x);
  PyObject * yarray = detail_matplotlib::get_array(y);
  PyObject * zarray = detail_matplotlib::get_array(z);
  ...
  const std::map<std::string, std::string> & keywords)
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_stem, args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords)
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_fill, args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords)
{
  ...
  // using numpy arrays
  PyObject * xarray  = detail_matplotlib::get_array(x);
  PyObject * y1array = detail_matplotlib::get_array(y1);
  PyObject * y2array = detail_matplotlib::get_array(y2);
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_fill_between, args, kwargs);
  ...
  Numeric head_width     = 0.1625)
{
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_arrow, plot_args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_hist, plot_args, kwargs);
  ...
  PyObject ** out)
{
  ...
  if (extent.size() == 4) {
    auto array = detail_matplotlib::get_array(extent);
    PyDict_SetItemString(kwargs, "extent", array);
  }

  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_imshow, args, kwargs);
  Py_DECREF(args);
  Py_DECREF(kwargs);
...
{
  detail_matplotlib::imshow(
    (void *)ptr, NPY_UINT8, rows, columns, colors, extent, keywords, out);  // NOLINT
}
...
{
  detail_matplotlib::imshow(
    (void *)ptr, NPY_FLOAT, rows, columns, colors, extent, keywords, out);  // NOLINT
}
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * kwargs = PyDict_New();
  PyDict_SetItemString(kwargs, "s", PyLong_FromLong(static_cast<long>(s)));  // NOLINT
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_scatter, plot_args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * xarray       = detail_matplotlib::get_array(x);
  PyObject * yarray       = detail_matplotlib::get_array(y);
  PyObject * colors_array = detail_matplotlib::get_array(colors);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * listlist = detail_matplotlib::get_listlist(data);
  PyObject * args     = PyTuple_New(1);
  ...
  if (!labels.empty() && labels.size() == data.size()) {
    PyDict_SetItemString(kwargs, "labels", detail_matplotlib::get_array(labels));
  }
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_boxplot, args, kwargs);
  ...
  const std::vector<Numeric> & data, const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * vector = detail_matplotlib::get_array(data);
  PyObject * args   = PyTuple_New(1);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_bar, plot_args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_barh, plot_args, kwargs);
...
inline bool subplots_adjust(const std::map<std::string, double> & keywords = {})
{
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_subplots_adjust, plot_args, kwargs);
  ...
  const std::vector<NumericX> & x, const std::vector<NumericY> & y, const std::string & s = "")
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_plot, plot_args);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_contour, plot_args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * xarray = detail_matplotlib::get_array(x);
  PyObject * yarray = detail_matplotlib::get_array(y);
  PyObject * uarray = detail_matplotlib::get_array(u);
  PyObject * warray = detail_matplotlib::get_array(w);
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_quiver, plot_args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * uarray = detail_matplotlib::get_array(u);
  PyObject * warray = detail_matplotlib::get_array(w);
  PyObject * varray = detail_matplotlib::get_array(v);
  ...
  PyObject * fig =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_figure,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple);
  if (!fig) throw std::runtime_error("Call to figure() failed.");
  ...
  const std::vector<NumericX> & x, const std::vector<NumericY> & y, const std::string & s = "")
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_stem, plot_args);
  ...
  const std::vector<NumericX> & x, const std::vector<NumericY> & y, const std::string & s = "")
{
  ...
  PyObject * res = PyObject_CallObject(
    detail_matplotlib::_interpreter::get().s_python_function_semilogx, plot_args);
  ...
  const std::vector<NumericX> & x, const std::vector<NumericY> & y, const std::string & s = "")
{
  ...
  PyObject * res = PyObject_CallObject(
    detail_matplotlib::_interpreter::get().s_python_function_semilogy, plot_args);
  ...
  const std::vector<NumericX> & x, const std::vector<NumericY> & y, const std::string & s = "")
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_loglog, plot_args);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * xarray    = detail_matplotlib::get_array(x);
  PyObject * yarray    = detail_matplotlib::get_array(y);
  PyObject * yerrarray = detail_matplotlib::get_array(yerr);
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_errorbar, plot_args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_plot, plot_args, kwargs);
  ...
  const std::string & format = "")
{
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_semilogx, plot_args, kwargs);
  ...
  const std::string & format = "")
{
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_semilogy, plot_args, kwargs);
  ...
  const std::string & format = "")
{
  ...
  PyTuple_SetItem(plot_args, 2, pystring);
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_loglog, plot_args, kwargs);
...
void text(Numeric x, Numeric y, const std::string & s = "")
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_text, args);
...
inline void colorbar(PyObject * mappable = NULL, const std::map<std::string, float> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_colorbar, args, kwargs);
...
inline long figure(long number = -1)  // NOLINT
{
  ...
  PyObject * res;
  if (number == -1) {
    res = PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_figure,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple);
  } else {
    assert(number > 0);
    ...
    res =
      PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_figure, args);
    Py_DECREF(args);
  }
...
inline bool fignum_exists(long number)  // NOLINT
{
  ...
  PyTuple_SetItem(args, 0, PyLong_FromLong(number));
  PyObject * res = PyObject_CallObject(
    detail_matplotlib::_interpreter::get().s_python_function_fignum_exists, args);
...
inline long figure_size(long number, size_t w, size_t h)  // NOLINT
{
  detail_matplotlib::_interpreter::get();
  ...
  PyObject * res;
  if (number == -1) {
    res = PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_figure,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple,
      kwargs);
  } else {
    assert(number > 0);
    ...
    PyTuple_SetItem(args, 0, PyLong_FromLong(number));
    res =
      PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_figure, args, kwargs);
    Py_DECREF(args);
  }
...
inline void figure_size(size_t w, size_t h)
{
  ...
  PyObject * res = PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_figure,
    detail_matplotlib::_interpreter::get().s_python_empty_tuple,
    kwargs);
...
inline void legend()
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_legend,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple);
...
inline void legend(const std::map<std::string, std::string> & keywords)
{
  ...
  PyObject * res = PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_legend,
    detail_matplotlib::_interpreter::get().s_python_empty_tuple,
    kwargs);
  if (!res) throw std::runtime_error("Call to legend() failed.");
...
inline void set_aspect(Numeric ratio)
{
  ...
  PyObject * ax = PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_gca,
    detail_matplotlib::_interpreter::get().s_python_empty_tuple);
...
void ylim(Numeric left, Numeric right)
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_ylim, args);
...
void xlim(Numeric left, Numeric right)
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_xlim, args);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  // using numpy array
  PyObject * ticksarray = detail_matplotlib::get_array(ticks);
  ...
  if (labels.size() == 0) {
    ...
    for (size_t i = 0; i < labels.size(); i++)
      PyTuple_SetItem(
        labelstuple, static_cast<Py_ssize_t>(i), PyUnicode_FromString(labels[i].c_str()));
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_xticks, args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_yticks, args, kwargs);
...
inline void margins(Numeric margin)
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_margins, args);
  ...
  const std::map<std::string, std::string> & keywords, const std::string axis = "both")
{
  ...
  PyObject * res = PyObject_Call(
    detail_matplotlib::_interpreter::get().s_python_function_tick_params, args, kwargs);
...
inline void subplot(long nrows, long ncols, long plot_number)  // NOLINT
{
  ...
  // construct positional args
  PyObject * args = PyTuple_New(3);
  PyTuple_SetItem(args, 0, PyLong_FromDouble(static_cast<double>(nrows)));
  PyTuple_SetItem(args, 1, PyLong_FromDouble(static_cast<double>(ncols)));
  PyTuple_SetItem(args, 2, PyLong_FromDouble(static_cast<double>(plot_number)));

  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_subplot, args);
...
inline void subplot2grid(long nrows,  // NOLINT
  long ncols,                         // NOLINT
  long rowid   = 0,                   // NOLINT
  long colid   = 0,                   // NOLINT
  long rowspan = 1,                   // NOLINT
  long colspan = 1)                   // NOLINT
{
  ...
  PyObject * res = PyObject_CallObject(
    detail_matplotlib::_interpreter::get().s_python_function_subplot2grid, args);
  ...
  const std::string & titlestr, const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_title, args, kwargs);
  ...
  const std::string & suptitlestr, const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_suptitle, args, kwargs);
...
inline void axis(const std::string & axisstr)
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_axis, args);
  if (!res) throw std::runtime_error("Call to title() failed.");
  ...
  const std::map<std::string, std::string> & keywords = std::map<std::string, std::string>())
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_axhline, args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = std::map<std::string, std::string>())
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_axvline, args, kwargs);
  ...
  const std::map<std::string, std::string> & keywords = std::map<std::string, std::string>())
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_axvspan, args, kwargs);
  Py_DECREF(args);
  Py_DECREF(kwargs);
  ...
  const std::string & str, const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_xlabel, args, kwargs);
  ...
  const std::string & str, const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_ylabel, args, kwargs);
  ...
  const std::string & str, const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_yscale, args, kwargs);
...
inline void grid(bool flag)
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_grid, args);
...
inline void show(const bool block = true)
{
  ...
  PyObject * res;
  if (block) {
    res = PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_show,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple);
  } else {
    PyObject * kwargs = PyDict_New();
    PyDict_SetItemString(kwargs, "block", Py_False);
    res = PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_show,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple,
      kwargs);
    Py_DECREF(kwargs);
  }
...
inline void close()
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_close,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple);
...
inline void xkcd()
{
  ...
  res = PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_xkcd,
    detail_matplotlib::_interpreter::get().s_python_empty_tuple,
    kwargs);
...
inline void draw()
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_draw,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple);
...
inline void pause(Numeric interval)
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_pause, args);
...
inline void save(const std::string & filename, const int dpi = 0)
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_save, args, kwargs);
...
inline void rcparams(const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * update = PyObject_GetAttrString(
    detail_matplotlib::_interpreter::get().s_python_function_rcparams, "update");
...
inline void clf()
{
  ...
  PyObject * res = PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_clf,
    detail_matplotlib::_interpreter::get().s_python_empty_tuple);
...
inline void cla()
{
  ...
  PyObject * res = PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_cla,
    detail_matplotlib::_interpreter::get().s_python_empty_tuple);
...
inline void ion()
{
  ...
  PyObject * res = PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_ion,
    detail_matplotlib::_interpreter::get().s_python_empty_tuple);
  ...
  const int numClicks = 1, const std::map<std::string, std::string> & keywords = {})
{
  ...
  PyObject * res =
    PyObject_Call(detail_matplotlib::_interpreter::get().s_python_function_ginput, args, kwargs);

  Py_DECREF(kwargs);
  Py_DECREF(args);
  if (!res) throw std::runtime_error("Call to ginput() failed.");

  const size_t len = static_cast<size_t>(PyList_Size(res));
...
inline void tight_layout()
{
  ...
  PyObject * res =
    PyObject_CallObject(detail_matplotlib::_interpreter::get().s_python_function_tight_layout,
      detail_matplotlib::_interpreter::get().s_python_empty_tuple);
...
{
  return detail_matplotlib::plot_impl<typename detail_matplotlib::is_callable<B>::type>()(
           a, b, format)
      && plot(args...);
}
...
public:
    ...
    const std::string & format = "")
  {
    ...
    PyObject * res = PyObject_Call(
      detail_matplotlib::_interpreter::get().s_python_function_plot, plot_args, kwargs);
...
#endif  // THREELAWS_MATPLOTLIBCPP_HPP
